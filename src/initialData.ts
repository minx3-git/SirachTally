...
export const initialAccounts: LedgerAccount[] = [
  ...
  {
    id: 'bank-balance',
    name: 'Bank Balance (INR Equivalents)',
    code: '1003',
    type: 'Asset',
    balance: 3892110.45,
    balanceType: 'Dr',
  ...
  {
    id: 'telecom-bills',
    name: 'Telecom & Broadband Expenses',
    code: '5010',
    type: 'Expense',
    balance: 0.00,
    balanceType: 'Dr',
    details: 'Automated Airtel Optical monthly billing'
  },
  {
    id: 'office-welfare',
    name: 'Office Welfare & Refreshments',
    code: '5011',
    type: 'Expense',
    balance: 0.00,
    balanceType: 'Dr',
    details: 'Pantry refreshments and employee welfare'
  },
  {
    id: 'petty-cash',
    ...
    balance: 15000.00,
    balanceType: 'Dr',
    details: 'Daily operations cash floats'
  },
  {
    id: 'raw-materials-asset',
    name: 'Raw Materials Asset Inventory',
    code: '1401',
    type: 'Asset',
    balance: 245000.00,
    balanceType: 'Dr',
    details: 'Inventory raw goods stocks'
  }
];
